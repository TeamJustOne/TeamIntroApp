...
class SplashViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        private func showMainView() {
            let storyboard = UIStoryboard(name: "ListPage", bundle: nil)
            let mainVC = storyboard.instantiateViewController(withIdentifier: "ListPageViewController") as! ListPageViewController
